# Dependabot Security Review — 2026-06-15
...
| `npm audit` | openclaw-redact-benchmark PR #2 branch | 2 high (esbuild/tsx chain) |
| `npm audit` | openclaw-redact-benchmark PR #3 branch | 0 vulnerabilities |
...
| Severity | Critical |
| CVSS | **9.8** |
| EPSS | **0.00232** (below 0.1 threshold; CVSS > 7.0 keeps high priority) |
...
- EPSS 0.00232 — below 0.1, but severity and dev-toolchain exposure warrant remediation.
...
| CI on PR | All checks green (verify + verify-openclaw-e2e) |
| `npm audit` on PR branch | 0 vulnerabilities |
